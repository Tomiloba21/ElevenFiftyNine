// // src/pages/CustomerOrderTracking.tsx
// import React, { useEffect, useState } from 'react';
// import { useOrder } from '../context/OrderContext';
// import { OrderResponse } from '../types/types';
// import { Package, Truck, CheckCircle, Clock, AlertCircle, Search, ChevronRight } from 'lucide-react';
...
//                 <p className="text-lg font-medium text-gray-900">${currentOrder.totalAmount?.toFixed(2) || '0.00'}</p>
//               </div>
//             </div>
//           </div>
          
//           {currentOrder.status === 'DELIVERED' && (
//             <div className="px-4 py-5 sm:px-6 border-t border-gray-200 bg-green-50">
