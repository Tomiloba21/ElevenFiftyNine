...
import { useState, useEffect } from 'react';
import { Link, useNavigate, useLocation } from 'react-router-dom';
import { ShoppingCart, Search, User, Menu, X, LogOut, Settings, Tag } from 'lucide-react';
import { useCart } from '../context/CartContext';
import AuthService from '../services/Authservice';
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            ...
            {isAdmin ? (
              ...
              <>
                ...
                <Link to="/admin/discounts" className="text-gray-600 hover:text-gray-900 flex items-center">
          ...
          <div className="flex flex-col space-y-2">
            ...
            {isAdmin ? (
              ...
              <>
                ...
                <Link to="/admin/discounts" className="px-3 py-2 text-gray-600 hover:bg-gray-100 rounded-md flex items-center">
